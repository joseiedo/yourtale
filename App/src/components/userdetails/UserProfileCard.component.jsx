    ...
    return <div className={styles.userCardWrapper}>
        <div className={`container mainContainer ${styles.userCard}`}>
            ...
            <div className={styles.userInfo}>
                ...
                <ProfileButtons isFriend={data?.isFriend} isLoggedUser={data?.isLoggedUser}/>
            </div>
        </div>
    </div>
}

function ProfileButtons({isFriend, isLoggedUser, handleEdit, isFriendRequestPending}) {

    if (isLoggedUser) return <button className="outline contrast" onClick={handleEdit}>Editar</button>
    ...
    return <button className="outline contrast">Adicionar amigo</button>
}
