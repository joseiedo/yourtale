...
export function Like({isLiked, likesQuantity, token, postId, getPostDetails}) {
    ...
    const HeartOutlineSvg = () => <svg clipRule="evenodd" fillRule="evenodd" strokeLinejoin="round"
                                       strokeMiterlimit="2"
    ...
    const FilledSvg = () => <svg clipRule="evenodd" fillRule="evenodd" strokeLinejoin="round" strokeMiterlimit="2"
                                 viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path
