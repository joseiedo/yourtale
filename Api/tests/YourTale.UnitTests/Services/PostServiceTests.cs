...
public class PostServiceTests
{
    ...
    public async Task GetPostsByUserId_WhenExistsAndIsFromCurrentUser_ShouldReturnPostsPaginated()
    {
        ...
        _postRepository.Setup(s => s.GetPostsByUserId(It.IsAny<bool>(), user.Id, 1, posts.Count)).ReturnsAsync(posts);
    ...
    public async Task GetPostsByUserId_WhenExistsAndIsFromFriend_ShouldReturnPostsPaginated()
    {
        ...
        _postRepository.Setup(s => s.GetPostsByUserId(It.IsAny<bool>(), friends[0].Id, 1, posts.Count))
            .ReturnsAsync(posts);
